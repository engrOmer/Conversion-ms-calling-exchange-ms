...
public class CurrencyConversion {
    public CurrencyConversion(Long id, String from, String to, BigDecimal conversionMultiple, BigDecimal quantity, BigDecimal totalCalculatedAmount, String environement) {
        this.id = id;
        this.from = from;
        this.to = to;
